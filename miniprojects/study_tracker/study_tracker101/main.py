...
def main():
    ...
    avg_hours = rolling_average(logs,"actual_hours")
    avg_attention = rolling_average(logs, "attention_percent")
    ...
    print("\nROLLING PERFORMANCE(7DAYS)\N")
    print(f"Avg study hours: {avg_hours}")
    print(f"avg attention: {avg_attention} %")
